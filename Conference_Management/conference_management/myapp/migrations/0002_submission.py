    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_reviewer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='assigned_submissions', to=settings.AUTH_USER_MODEL)),
